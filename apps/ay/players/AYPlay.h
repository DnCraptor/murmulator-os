...
#define GET_PTR(x) {unsigned long tmp; GET_WORD(tmp); if(tmp >= 0x8000) tmp=-0x10000+tmp; (x)=ptr-2+tmp;}
    ayData* aydata = (ayData*)calloc(1, sizeof(ayData));
    ...
    if(*ptr == 'Z' && *(ptr + 1) == 'X' && *(ptr + 2) == 'A' && *(ptr + 3) == 'Y' && *(ptr + 4) == 'E' && *(ptr + 5) == 'M' && *(ptr + 6) == 'U' && *(ptr + 7) == 'L')
    {
        ...
        GET_PTR(ptr2);
        ptr = ptr2;
        if((aydata->tracks = calloc(aydata->num_tracks, sizeof(ayTrack))))
        {
...
#define GET_PTR(x) {unsigned long tmp; GET_WORD(tmp); if(tmp >= 0x8000) tmp=-0x10000+tmp; (x)=ptr-2+tmp;}
    ...
    if(*ptr == 'Z' && *(ptr + 1) == 'X' && *(ptr + 2) == 'A' && *(ptr + 3) == 'Y' && *(ptr + 4) == 'E' && *(ptr + 5) == 'M' && *(ptr + 6) == 'U' && *(ptr + 7) == 'L')
    {
        ...
        GET_PTR(ptr2);
        ptr = ptr2;
        if((aydata_loc.tracks = calloc(aydata_loc.num_tracks, sizeof(ayTrack))))
        {
